...
import '/components/text_message/text_message_widget.dart';
          ...
          return wrapWithModel(
            ...
            child: BannerCardWidget(
              ...
              callback: (message) async {
                logFirebaseEvent('MESSAGE_COMP_Container_flgdpmp0_CALLBACK');
                logFirebaseEvent('BannerCard_execute_callback');
