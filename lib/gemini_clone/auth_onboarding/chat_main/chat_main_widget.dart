...
import '/gemini_clone/auth_onboarding/chat_thread/chat_thread_widget.dart';
...
import '/gemini_clone/auth_onboarding/dropdown_edit_conversation/dropdown_edit_conversation_widget.dart';
...
class _ChatMainWidgetState extends State<ChatMainWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      logFirebaseEvent('ChatMain_update_page_state');
                    ...
                    children: [
                      Padding(
                        ...
                        child: FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            logFirebaseEvent(
                                'CHAT_MAIN_PAGE_menu_rounded_ICN_ON_TAP');
                      ...
                      MouseRegion(
                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'CHAT_MAIN_PAGE_Container_xtwrg8i5_ON_TAP');
                                      ...
                                      itemBuilder: (context, listViewIndex) {
                                        ...
                                        return Builder(
                                          builder: (context) => wrapWithModel(
                                            model: _model.conversationCardModels
                                                .getModel(
                                            ...
                                            child: ConversationCardWidget(
                                              key: Key(
                                                'Keye2i_${listViewConversationsRecord.reference.id}',
                                              ),
                                              convoName:
                                                  listViewConversationsRecord
                                                      .name,
                                              action: () async {
                                                logFirebaseEvent(
                                                    'CHAT_MAIN_Container_e2i59snf_CALLBACK');
                                                logFirebaseEvent(
                                                    'conversationCard_alert_dialog');
                                                await showDialog(
                                                  context: context,
                                          ...
                                          children: [
                                            Expanded(
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'CHAT_MAIN_PAGE_Container_rkr6cetb_ON_TAP');
                                                  logFirebaseEvent(
                                                          ...
                                                          padding:
                                                              const EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      0.0),
                                                          child: Text(
                                                            'Tell me how I can grow my audience and increase engagement.',
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .labelSmall
                                                                .override(
                                                          ...
                                                          padding:
                                                              const EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      0.0),
                                                          child: Text(
                                                            'Give me tips and tools to enhance the quality and cultural depth of my lyrics.',
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .labelSmall
                                                                .override(
                                                          ...
                                                          padding:
                                                              const EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      0.0),
                                                          child: Text(
                                                            'Break down potential revenue streams such as streaming, merch, live shows, and crowdfunding.',
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .labelSmall
                                                                .override(
                                            ...
                                            Expanded(
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'CHAT_MAIN_PAGE_Container_j2ngrzbe_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Container_bottom_sheet');
                                                  await showModalBottomSheet(
                                                    isScrollControlled: true,
                                                          ...
                                                          padding:
                                                              const EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      0.0),
                                                          child: Text(
                                                            'What are the best ways to use AI tools to improve my music production?',
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .labelSmall
                                                                .override(
