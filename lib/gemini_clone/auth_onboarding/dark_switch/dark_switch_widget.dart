...
class _DarkSwitchWidgetState extends State<DarkSwitchWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('DARK_SWITCH_darkSwitch_ON_INIT_STATE');
      logFirebaseEvent('darkSwitch_update_app_state');
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      onTap: () async {
        logFirebaseEvent('DARK_SWITCH_COMP_lightDark_small_ON_TAP');
        if (Theme.of(context).brightness == Brightness.light) {
          // makeDarkMode
          logFirebaseEvent('lightDark_small_makeDarkMode');
          ...
          // makeLightMode
          logFirebaseEvent('lightDark_small_makeLightMode');
