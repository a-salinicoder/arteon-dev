...
class _AccountCreateWidgetState extends State<AccountCreateWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'AccountCreate'});
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'ACCOUNT_CREATE_CREATE_ACCOUNT_BTN_ON_TAP');
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'ACCOUNT_CREATE_CONTINUE_WITH_GOOGLE_BTN_');
                                  logFirebaseEvent('Button_auth');
                                  GoRouter.of(context).prepareAuthEvent();
                            ...
                            isAndroid
                                ...
                                : Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'ACCOUNT_CREATE_CONTINUE_WITH_APPLE_BTN_O');
                                        logFirebaseEvent('Button_auth');
                                        GoRouter.of(context).prepareAuthEvent();
                                        final user = await authManager
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'ACCOUNT_CREATE_RichText_zpa1ohe8_ON_TAP');
