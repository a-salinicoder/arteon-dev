...
class AccountLoginWidget extends StatefulWidget {
  ...
  @override
  State<AccountLoginWidget> createState() => _AccountLoginWidgetState();
}

class _AccountLoginWidgetState extends State<AccountLoginWidget>
    with TickerProviderStateMixin {
  late AccountLoginModel _model;
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'ACCOUNT_LOGIN_CONTINUE_WITH_GOOGLE_BTN_O');
                                  logFirebaseEvent('Button_auth');
                                  GoRouter.of(context).prepareAuthEvent();
                            ...
                            isAndroid
                                ...
                                : Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'ACCOUNT_LOGIN_CONTINUE_WITH_APPLE_BTN_ON');
                                        logFirebaseEvent('Button_auth');
                                        GoRouter.of(context).prepareAuthEvent();
                                        final user = await authManager
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'ACCOUNT_LOGIN_RichText_pjucykxs_ON_TAP');
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'ACCOUNT_LOGIN_FORGOT_PASSWORD_BTN_ON_TAP');
                                  logFirebaseEvent('Button_navigate_to');

                                  context.pushNamed('Account_ForgotPassword');
                                },
